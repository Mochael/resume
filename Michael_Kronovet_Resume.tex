...
\AddToShipoutPicture* %515,738
	{\put(515,738){\includegraphics[width=2.25cm,height=1.5cm]{logoGreen.png}}}
...
\begin{tikzpicture}[remember picture,overlay]
	\clip ($(current page text area.north east)!0.64!(current page text area.south east)!.925!(current page text area.north west)$)
		circle (1.5cm) node {\includegraphics[width=0.2\linewidth]{myPic.jpg}};
	\end{tikzpicture}

	% \begin{tikzpicture}[remember picture,overlay]
	% 	\put(1,-90){\includegraphics[width=0.15\linewidth]{myEdit.png}};
	% 	\end{tikzpicture}

	% \begin{tikzpicture}[remember picture,overlay]
	% 	\put(56,-69){\includegraphics[width=0.30\linewidth]{textBub2.png}};
	% 	\end{tikzpicture}


\hspace{1.2in} \textbf{\huge Michael E.} \\
\vspace{6pt}
\hspace{1.2in} \textbf{\Huge \textcolor{myGreen}{Kronovet}}
...
\hspace{4.8in} \href{https://michaelkronovet.com}{\textbf{ \textcolor{myGreen}{michaelkronovet.com}}} \\
\vspace{0.01in}
\hspace{4.68in}  \textbf{mkronovet@gmail.com} \\
\vspace{0.05in}
%\end{tabular*}
%\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\resheading{Projects \& Activities}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\vspace{-5pt}
\begin{enumerate}[leftmargin=10pt]
...
\item[] \textbf{Muon Scattering Tomography Developer} \cftdotfill{\cftdotsep} August 2016 -- May 2017\\
\vspace{-4pt}	
\begin{itemize}
	\resitem{Built prototype that used silicon photomultiplier arrays paired with organic scintillators to determine the trajectory of cosmic ray muons, reducing the costs of muon tomography.}
	\resitem{\textbf{\textcolor{myGreen}{Placed 3rd}} in Physics and Astronomy at Intel International Science and Engineering Fair.}
\end{itemize}
...
\vspace{-5pt}
	\begin{enumerate}[leftmargin=10pt]
		\itemsep0em
		\item[] \textbf{Skills}: Python, C, R, SQL, Tableau, Javascript, HTML/CSS, Matlab, CAD, Unity, Microsoft Excel
		\item[] \textbf{Interests}: Data Science, Artificial Intelligence, Statistical Inference, Bioinformatics, Computer Vision
