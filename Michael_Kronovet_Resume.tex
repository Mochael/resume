...
\begin{enumerate}[leftmargin=10pt]
	...
	\item[] \large Oversaw the entirety of Palantir's work with the US Department of State
	\begin{itemize}
		\resitem{Converted 3 new contracts and doubled ARR from \$20M to \$50M without increasing headcount}
		\resitem{Led deployment of LLMs for Palantir’s first entirely LLM-based contract, achieving the highest number of LLM users across all of Palantir}
	\end{itemize}
\end{enumerate}
...
\begin{enumerate}[leftmargin=10pt]
	...
	\item[] \large Built the machine learning backend for Curia.ai from scratch and created novel causal inference algorithms for evaluating patient health
\end{enumerate}
